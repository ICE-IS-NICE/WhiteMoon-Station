...
/datum/revolution_handler/proc/declare_heads_win()
	...
	priority_announce("Похоже, мятеж подавлен. Пожалуйста, верните себя и своих недееспособных коллег к работе. \
		Мы удаленно добавили в черный список главных революционеров в ваших медицинских записях, чтобы предотвратить случайное оживление.", null, null, null, "[command_name()]: Отдел Мониторинга Лояльности")
