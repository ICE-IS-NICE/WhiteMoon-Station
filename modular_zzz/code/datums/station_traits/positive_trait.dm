...
/datum/station_trait/assistants_as_expeditioners
	...
	report_message = "Мы решили записать абсолютно всех ассистентов с вашей станции в Экспедиционный Корпус. Теперь у них есть доступ к ЕВА, к ГЕЙТ, пять тысяч кредитов и доступ к ношению оружия сверху."
...
/datum/station_trait/assistants_as_expeditioners/proc/send_expedition_announcement()
	priority_announce(
		...
		Вам выданы расширенные доступы к EVA и в ГЕЙТ, бонус в размере 5000 кредитов на ваши банковские счета, а также доступ к ношению оружия сверху. \
